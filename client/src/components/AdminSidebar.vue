<template>
  <div class="h-screen w-64 bg-[#1a1f3a] flex flex-col fixed left-0 top-0">
    <!-- Logo Section -->
    <div class="p-6 border-b border-gray-700/50">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-white font-bold text-lg">TaskFlow</h2>
          <p class="text-gray-400 text-xs">Distributed Task Scheduler</p>
        </div>
      </div>
    </div>
    ...
    <div class="px-6 py-4 border-t border-gray-700/50">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          ...
          <span class="text-sm font-medium text-green-500">Healthy</span>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 border-t border-gray-700/50 bg-gray-800/30">
      <div class="flex items-center gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-xs text-gray-400 truncate">{{ user?.email || 'admin@taskflow.com' }}</p>
        </div>
        <button @click="showLogoutModal = true" class="text-gray-400 hover:text-red-400 transition-colors hover:scale-110">
